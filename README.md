...
# Three versions of HAT's: SX-HAT is with (LowPass filters, PA and IPX connectors), second one is with (BandPass filters, PA and SMA connectors) and thirt one is with BandPass filters, ceramic antennas and without PA.
