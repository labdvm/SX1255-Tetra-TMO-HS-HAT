...
# Three versions of HAT's: HAT with (LPF_TX, BPF_TX filters and PA)/ HAT with (LPF_TX, BPF_TX filters without PA) and HAT with (BandPass filters, ceramic antennas without PA).
